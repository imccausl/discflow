...
export const Disc: React.FC<DiscItemProps> = ({
    name,
    plastic,
    flightNumbers,
    status,
    ...
    return (
        <div className="mb-2 flex min-w-full flex-col justify-between rounded-lg border-[1px] border-gray-200 px-0 py-0 shadow-sm">
